...
CREATE TABLE `restaurants` (
  `RestuarantId` int NOT NULL AUTO_INCREMENT,
  `Name` varchar(255) DEFAULT NULL,
  `Location` varchar(255) DEFAULT NULL,
  `ContactInformation` varchar(255) DEFAULT NULL,
  `OperationHours` varchar(255) DEFAULT NULL,
...
--
-- Dumping events for database 'best_restaurants'
--
...
-- Dump completed on 2022-07-28 11:37:24
